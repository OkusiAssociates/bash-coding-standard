...
# Test: exact code count is 106 (12 section overviews + 94 substantive rules)
begin_test 'exactly 106 BCS codes'
assert_equal 106 "$code_count" "exactly 106 codes (got $code_count)" || true
