...
description: |
  Use this agent when you need to generate comprehensive documentation for code, projects, or systems. This includes creating README files, API documentation, user guides, technical specifications, installation guides, and inline code documentation. The agent produces clear, well-structured, and maintainable documentation that follows best practices.
