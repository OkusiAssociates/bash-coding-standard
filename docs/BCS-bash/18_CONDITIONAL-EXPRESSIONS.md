...
string1 == string2
string1 = string2
 True if the strings are equal. When used with [[, this performs pattern matching as described under
 Compound Commands.
...
arg1 OP arg2
 ...
 arg2, respectively. Arg1 and arg2 may be positive or negative integers. Within [[, Arg1 and Arg2 are
 evaluated as arithmetic expressions (see ARITHMETIC EVALUATION).
