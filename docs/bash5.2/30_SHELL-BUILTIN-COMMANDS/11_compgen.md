...
compgen [option] [word]
 ...
 output.  When using the -F or -C options, the various shell variables set by the programmable
 ...
 directly from a completion specification with the same flags.  If word is specified, only those
