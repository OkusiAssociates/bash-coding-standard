...
getopts optstring name [arg ...]
 ...
 variable name, initializing name if it does not exist, and the index of the next argument to be
 ...
 reporting is used.  In normal operation, diagnostic messages are printed when invalid options or
 missing option arguments are encountered. If the variable OPTERR is set to 0, no error messages will
 be displayed, even if the first character of optstring is not a colon.
